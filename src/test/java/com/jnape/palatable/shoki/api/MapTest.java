...
public class MapTest {
    ...
    public void sameEntriesDetritus() {
        assertTrue(Map.equals(HashMap.of((k4, k23) -> k4 % 2 == k23 % 2,
                                              k4 -> k4.hashCode() % 2,
                                         tuple(1, true),
                                         tuple(2, false),
                                         tuple(3, false),
        ...
        assertTrue(Map.equals(of(tuple(3, false),
        ...
        assertFalse(Map.equals(HashMap.of((k1, k21) -> k1 % 2 == k21 % 2, k1 -> k1.hashCode() % 2,
                                          tuple(4, true),
                                          tuple(3, false),
                                          tuple(2, false),
        ...
        assertFalse(Map.equals(HashMap.<Integer, Boolean>empty()
                                            .put(3, false)
    ...
    public void sameEntries() {
        assertTrue(Map.equals(empty(), empty(), objectEquals()));
        assertTrue(Map.equals(empty().put(1, 1), empty().put(1, 1), objectEquals()));
        assertTrue(Map.equals(empty().put(1, 1).put(2, 2).remove(2), empty().put(1, 1), objectEquals()));

        assertTrue(Map.equals(of(tuple(1, true), tuple(2, false)), of(tuple(1, true), tuple(2, false)), (v1, v2) -> true));
    }
    ...
    public void sameEntriesDoesNotProveSymmetry() {
        ...
        HashMap<Integer, Boolean> m2 = HashMap.of((k1, k2) -> k1 % 2 == k2 % 2,
                                                  ...
                                                  tuple(3, false),
                                                  tuple(4, true));
        assertTrue(Map.equals(m1, m2, objectEquals()));
        assertFalse(Map.equals(m2, m1, objectEquals()));
    }
