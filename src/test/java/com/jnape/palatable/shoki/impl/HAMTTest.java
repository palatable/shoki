...
public class HAMTTest {
        ...
        public void put() {
            ...
            assertEquals(new Node<>(1,
                                    new Object[]{new Collision<>("bar".hashCode(),
                                                                 amortizedStack(new Entry<>("foo", 1),
                                                                                new Entry<>("bar", 2)))}),
    ...
    public static final class CollisionTest {
        ...
        @Before
        public void setUp() {
            collision = new Collision<>(0, amortizedStack(new Entry<>("foo", 1),
                                                          new Entry<>("bar", 2),
                                                          new Entry<>("baz", 3)));
        }
        ...
        @Test
        public void put() {
            assertEquals(new Collision<>(0, amortizedStack(new Entry<>("baz", 3),
                                                           new Entry<>("bar", 2),
                                                           new Entry<>("foo", -1))),
        ...
        public void remove() {
            ...
            assertEquals(new Collision<>(0, amortizedStack(new Entry<>("bar", 2),
                                                           new Entry<>("foo", 1))),
        ...
        public void equalsAndHashCode() {
            assertEquals(new Collision<>(0, amortizedStack()), new Collision<>(0, amortizedStack()));
            assertNotEquals(new Collision<>(0, amortizedStack()),
                            new Collision<>(1, amortizedStack()));
            assertEquals(new Collision<>(0, amortizedStack(new Entry<>("foo", 1))),
                         new Collision<>(0, amortizedStack(new Entry<>("foo", 1))));
            assertNotEquals(new Collision<>(0, amortizedStack()),
                            new Collision<>(0, amortizedStack(new Entry<>("foo", 1))));

            assertNotEquals(new Collision<>(0, amortizedStack()), new Object());
        }
    }
    ...
    public static final class NodeTest {
        ...
        public void iteratesAllEntries() {
            assertThat(new Node<>(0, new Object[]{
                               ...
                               new Collision<>(0, amortizedStack(new Entry<>("baz", 3),
                                                                 new Entry<>("quux", 4)))}),
                       iterates(tuple("foo", 1),
                                tuple("bar", 2),
                                tuple("baz", 3),
